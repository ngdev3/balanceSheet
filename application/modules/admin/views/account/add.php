                                    ...
                                    <div class="mT-30">
                                        <?php echo form_open_multipart('', array('class' => '', 'id' => 'ciatyform_id',)); ?>
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputState2">Khata Entry No. *</label>
                                                    <?php  $nameS = @$result->khata_entry_no;
                                                    $postvalueS = @strtotime(date('d-m-y'));
                                                    echo form_input(array('readonly'=>'readonly','name' => 'khata_entry_no','maxlength'=>'25', 'class' => 'form-control', 'id' => 'khata_entry_id', 'placeholder' => 'Khata Entry No', 'value' => !empty($postvalueS) ? $postvalueS : $nameS ));
                                                 ?>
                                                   <label  class="error"><div class="help-block" style="color:red"> <?php echo form_error('khata_entry_no'); ?></div></label>
...
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                               echo form_input(array('autofocus'=>'autofocus','name' => 'account_name','maxlength'=>'100', 'class' => 'form-control', 'id'=>'myInput', 'placeholder' => 'Account Name', 'value' => !empty($postvalue) ? $postvalue : $name ));
                                            ?>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputState2">Type*</label>
                                                   <select id="inputState2" class="form-control" name="type_of_account">
                                                       <option value="expenses" selected>Account (नाम)</option>
                                                   </select>                                         
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="inputState2">Karch Amount. *</label>
                                                    <?php  $name = @$result->karch_amount;
                                                    $postvalue = @$_POST['karch_amount'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                                    echo form_input(array('type' =>'number' , 'step'=>'0.01', 'min' =>'0', 'name' => 'karch_amount','maxlength'=>'25', 'class' => 'form-control', 'id' => 'final_amount', 'placeholder' => 'Karch Amount', 'value' => !empty($postvalue) ? $postvalue : $name ));
                                                 ?>
