...
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                                    echo form_input(array('type' =>'number' , 'step'=>'0.01', 'min' =>'0', 'name' => 'karch_amount','maxlength'=>'25', 'class' => 'form-control', 'id' => 'final_amount', 'placeholder' => 'Purchaser Amount.', 'value' => !empty($postvalue) ? $postvalue : $name ));
                                                 ?>
