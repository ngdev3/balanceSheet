...
//                                                    $val = !empty($postvalue)? $postvalue:$name;
									...
									<div class="form-row">
										<div class="form-group col-md-6">
											<label for="inputState2">Type of Invoice*</label>
											<select id="inputState2" class="form-control" name="type_of_invoice">
												<option value="1">Tax Invoice</option>
												<option value="2">Bill of Supply</option>
											</select>
										</div>
										<div class="form-group col-md-6">
...
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                  ...
                  <div class="form-row">
                  <div class="form-group col-md-6">
											<label for="inputState2">Others*</label>
											<?php  
                                               $name = @$result->others;
                                               $postvalue = @$_POST['others'];
//                                                    $val = !empty($postvalue)? $postvalue:$name;
                                               echo form_input(array('autofocus'=>'autofocus','name' => 'others','maxlength'=>'100','class' => 'form-control',  'placeholder' => 'Others', 'value' => !empty($postvalue) ? $postvalue : $name ));
                                            ?>
												<label class="error">
													<div class="help-block" style="color:red">
