...
class Invoice extends CI_Controller {
    ...
    function __construct() {
		...
		$taxinvoice_no = intVal($this->Invoice_mod->getTaxId()->taxinvoice_id);
		//pr(($taxinvoice_no+1)); die;
	...
	$username = "crindustries2020@gmail.com";
	$hash = "3c02226700a28f039055899eb679c9890e284975a37b45c4fcda7753b833733f";
	...
	$numbers = "8887905070"; // A single number or a comma-seperated list of numbers
        ...
        if (isPostBack()) {
			...
			if ($this->form_validation->run() == false) {
				...
				$expenses_data = array(
					...
					// pr($_POST);
					if($_POST['type_of_invoice'] != 2 || $_POST['product_name'] != 'Rice Bran'){ //221 Tax Invoice | 
						$result = $this->Invoice_mod->add_rokadh_entry($deposit_data , $expenses_data);
					}
				$result = $this->Invoice_mod->add($userdata);
